...
module.exports = __webpack_require__(34).polyfill();
...
var get_template = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(template_name) {
  ...
  return function get_template(_x) {
...
function determineDate() {
  new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 83)).then(function (moment) {
    return moment().format('LLLL');
  }).then(function (str) {
    return console.log('es2015', str);
  }).catch(function (err) {
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 83));
